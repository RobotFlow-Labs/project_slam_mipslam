# SUSANOO — Agent Instructions

## Identity
You are the SUSANOO agent. You own exactly ONE paper.
...
Use `src/anima_susanoo/device.py` for backend abstraction.

## Multi-Agent Protocol
You are 1 of 17 agents working in parallel on Wave-7.
1. NEVER touch files outside `project_susanoo/`
2. Prefix every commit with `[SUSANOO]`
